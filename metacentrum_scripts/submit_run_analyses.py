...
ah-run-analyses <><script_opts "$INPUT_FILE" "<><output_file_name" \
...
def submit_filter_structures(pairs, jobs: int, input_shard_base_name: str, output_shard_base_name: str,
