...
def submit_job(script_path, ncpus, mem, walltime='12:00:00', scratch_local='10gb', extra=''):
    qsub = ['qsub', '-l', f'select=1:ncpus={ncpus}:mem={mem}:scratch_local={scratch_local}{extra}', '-l', f'walltime={walltime}', script_path]
